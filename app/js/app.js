...
var john = new _Person2.default("John", "Brown");
john.greet();

var jane = new _Person2.default("Jane", "Blue");
jane.greet();
...
var Person = function () {
    function Person(name, hairColor) {
        ...
        this.name = name, this.hairColor = hairColor;
    }
...
exports.default = Person; // This sets out what gets exported from this file - es6 notation
